...
const NavMd = () => {
    return <>
        <div className="w-full flex items-center gap-3 py-2 px-3 bg-white rounded-md">
            <BiSearch />
    ...
    return <>
        ...
        <div className="container mx-auto px-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
                <span className="text-gray-300 text-md flex items-center hover:text-white cursor-pointer">Bengaluru<BiChevronDown /></span>
                <button className="bg-logored-300 text-white px-2 py-1 text-sm rounded">Sign in</button>
